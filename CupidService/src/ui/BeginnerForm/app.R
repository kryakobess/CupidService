...
parseInput <- function(input_df) {
  print(as.numeric(input_df[1,]$age))
  diff_df = data.frame(
    int_corr = integer(),
    age_dif = integer(),
    imprace_dif = integer(),
  ...
  diff_df[1,]$age_dif = abs(as.numeric(input_df[1,]$age) - as.numeric(input_df[1,]$age))
  diff_df[1,]$sports_dif = abs(as.numeric(input_df[1,]$sports) - as.numeric(input_df[1,]$sports))
  diff_df[1,]$tvsports_dif = abs(as.numeric(input_df[1,]$tv_sports) - as.numeric(input_df[1,]$tv_sports))
  diff_df[1,]$exercise_dif = abs(as.numeric(input_df[1,]$exercise) - as.numeric(input_df[1,]$exercise))
  diff_df[1,]$gaming_dif = abs(as.numeric(input_df[1,]$gaming) - as.numeric(input_df[1,]$gaming))
  diff_df[1,]$clubbing_dif = abs(as.numeric(input_df[1,]$clubbing) - as.numeric(input_df[1,]$clubbing))
  diff_df[1,]$reading_dif = abs(as.numeric(input_df[1,]$reading) - as.numeric(input_df[1,]$reading))
  diff_df[1,]$shopping_dif = abs(as.numeric(input_df[1,]$shopping) - as.numeric(input_df[1,]$shopping))
  diff_df[1,]$yoga_dif = abs(as.numeric(input_df[1,]$yoga) - as.numeric(input_df[1,]$yoga))
  diff_df[1,]$attr1_1_dif = abs(as.numeric(input_df[1,]$attr) - as.numeric(input_df[1,]$attr))
  diff_df[1,]$sinc1_1_dif = abs(as.numeric(input_df[1,]$sinc) - as.numeric(input_df[1,]$sinc))
  diff_df[1,]$intel1_1_dif = abs(as.numeric(input_df[1,]$intel) - as.numeric(input_df[1,]$intel))
  diff_df[1,]$fun1_1_dif = abs(as.numeric(input_df[1,]$fun) - as.numeric(input_df[1,]$fun))
  diff_df[1,]$amb1_1_dif = abs(as.numeric(input_df[1,]$amb) - as.numeric(input_df[1,]$amb))
  diff_df[1,]$shar1_1_dif = abs(as.numeric(input_df[1,]$shar) - as.numeric(input_df[1,]$shar))
  diff_df[1,]$attr2_1_dif = abs(as.numeric(input_df[1,]$attr_a) - as.numeric(input_df[1,]$attr_a))
  diff_df[1,]$sinc2_1_dif = abs(as.numeric(input_df[1,]$sinc_a) - as.numeric(input_df[1,]$sinc_a))
  diff_df[1,]$intel2_1_dif = abs(as.numeric(input_df[1,]$intel_a) - as.numeric(input_df[1,]$intel_a))
  diff_df[1,]$fun2_1_dif = abs(as.numeric(input_df[1,]$fun_a) - as.numeric(input_df[1,]$fun_a))
  diff_df[1,]$amb2_1_dif = abs(as.numeric(input_df[1,]$amb_a) - as.numeric(input_df[1,]$amb_a))
  diff_df[1,]$shar2_1_dif = abs(as.numeric(input_df[1,]$shar_a) - as.numeric(input_df[1,]$shar_a))
...
server <- function(input, output) {
  ...
  observeEvent(input$doneButton, {
    ...
    newdf[nrow(newdf) + 1,] = c(
      ...
      input$attr_a, input$sinc_a, input$intel_a, input$fun_a, input$amb_a, input$shar_a   
    )
